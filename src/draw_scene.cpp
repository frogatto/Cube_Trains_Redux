...
//	}
	...
	if(pos.flip_rotate) {
		...
		GLshort varray2[8] = {(GLshort)(preferences::actual_screen_width() - pixels),0,  (GLshort)(preferences::actual_screen_width()),0,  (GLshort)(preferences::actual_screen_width()),(GLshort)(preferences::actual_screen_height()), (GLshort)(preferences::actual_screen_width() - pixels,preferences::actual_screen_height())};
